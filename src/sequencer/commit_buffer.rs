...
impl CommitBuffer {
    pub fn new(config: AtomicConfig, block_rx: Receiver<(SenderType, CachedBlock)>, auditor_tx: Sender<CachedBlock>, reconfiguration_coordinator_tx: tokio::sync::mpsc::UnboundedSender<(String /* worker name */, u64 /* seq num */)>) -> Self {
